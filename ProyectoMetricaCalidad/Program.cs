...
using AplicacionProyectoMetrica.MapperProyect;
using AplicacionProyectoMetrica.Repositorio.IRepository;
using AplicacionProyectoMetrica.Repositorio;
using ProyectoMetricaCalidad.Repositorio.IRepository;
using ProyectoMetricaCalidad.Repositorio;
...
builder.Services.AddAutoMapper(typeof(MetricaMapper));
